<?php 
$level="content_product_type/";
include "index_data_type.php";
?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="text-center">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				   ...
				   <a href="content_product_type/content_add_product_type.php" class="btn btn-success pull-right">	
                    <span> Add Type  </span>
					</a>
			...
			?>	
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $list['ProductTypeCode']  ?></td>
									 
                                   
                                    <td class="text-center"> <?php echo $list['ProductTypeName']  ?></td>
									  
                                    <td class="text-center">
                                       <a   class="text" href ="<?php echo $level."content_update_product_type.php?id=".$list['ID'] ?>">  <button class="btn btn-warning">
                                           Update 
                                        </button>
										</a>
                                        &nbsp;
                                        <a   class="text" href ="<?php echo $level."delete_type.php?id=".$list['ID'] ?>">  <button  type="button"class="btn btn-warning">
                                           Delete
                                        </button>
										</a>
                                    </td>
